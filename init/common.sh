...
mkdir -p ~/node/socket
cd ~/node/config
wget -O topology.json https://hydra.iohk.io/build/3554884/download/1/mainnet_candidate-topology.json
wget -O sgenesis.json https://hydra.iohk.io/build/3554884/download/1/mainnet_candidate-shelley-genesis.json
wget -O bgenesis.json https://hydra.iohk.io/build/3554884/download/1/mainnet_candidate-byron-genesis.json
wget -O config.json https://hydra.iohk.io/build/3554884/download/1/mainnet_candidate-config.json
